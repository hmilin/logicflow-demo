...
/**
 * https://github1s.com/didi/LogicFlow/blob/HEAD/packages/extension/src/components/mini-map/index.ts
 * 从官方插件复制过来的，修改了：
 * 1. 支持传入plugins进行覆盖
 */
...
class MiniMap {
  ...
  */
  ...
  // 设置视口
  private setViewPort(scale, { left, right }) {
